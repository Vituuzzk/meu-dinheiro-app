...
(function(global) {
    ...
    function renderizarDashboard(estado, utils, mascaras, calculos) {
        ...
        const { calcularSaldoTotal, calcularSaldoProjetado, calcularReceitasMes, calcularDespesasMes, calcularSaldoConta, calcularFaturaAtual } = calculos;
